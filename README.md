...
기존 글의 문체를 반영해 원고를 작성하고 티스토리에 전송하는 로컬 웹앱을 개발하는 프로젝트입니다. P0 브라우저 자동화 검증을 마쳤으며, P1에서는 **수동 원고 편집·사진 관리·블로그 연결·작업 내역**을 제공하는 로컬 웹앱을 구현했습니다. AI 생성과 기존 문체 분석은 후속 단계입니다.
...
사진은 본문 아래에 순서대로 배치됩니다. PNG·JPEG·WebP를 장당 10MB, 원고당 20장까지 받으며 실제 파일을 디코딩하고 메타데이터를 제거한 PNG로 보관합니다. 요약은 작성 메모이며 자동으로 본문에 포함되지 않습니다. AI 생성은 아직 제공하지 않습니다.
